...
namespace Test
{
    public class DAL
    {
        ...
        public DAL()
        {
            ConnString = "Data Source=localhost;Initial Catalog=test;Integrated Security=SSPI"; // Set the internal variable ConnString to the value of the user chosen value connString
