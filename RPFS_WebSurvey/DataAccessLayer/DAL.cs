...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            ConnString = "Data Source=localhost\\SQLEXPRESS;Initial Catalog=dbSurvey;Integrated Security=SSPI"; // Set the internal variable ConnString to the value of the user chosen value connString
